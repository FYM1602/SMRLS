Selective Memory Recursive Least Squares (SMRLS) is an recursive least squares (RLS) based real-time training algorithm for linearly parameterized approximators. This project is 
a demo for radial basis function neural network (RBFNN) based real-time function approximation with SMRLS. The function of each file is explained as follows: 
